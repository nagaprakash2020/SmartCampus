...
public class Announcements extends ListActivity{
    ...
    @Override
        ...
        dialog=new ProgressDialog(Announcements.this);
		dialog = ProgressDialog.show(Announcements.this, "","Processing Request, Please Wait...", true);
    ...
    public void updateList() {
    	...
    	Intent webView=new Intent(Announcements.this,ShowWebView.class);
    ...
    private class GetFeeds extends AsyncTask<Object, Object, List<RSSItem>>
    {
		...
		protected List<RSSItem> doInBackground(Object... arg0) {
	        ...
	        String uri = "http://events.fau.edu/MasterCalendar/RSSFeeds.aspx?data=hhAbVFpDFO7OxcTcYlM9LlB3GnBSGG5DLCjLSIlDRFlJ9aGPABdvYq0gy%2fCmaS1c";
			try {
