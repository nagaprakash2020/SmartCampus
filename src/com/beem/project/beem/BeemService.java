...
//         SmackConfiguration.setPacketReplyTimeout(30000);
	...
	//if (mSettings.getBoolean("settings_key_specific_server", false))
		...
		mConnectionConfiguration=new ConnectionConfiguration("ec2-54-234-138-249.compute-1.amazonaws.com", 5222, "amazona-2r9gfi9");
	/*else
	...
	System.out.println(tmpJid+".....................TEMP ID");
	...
	if (mSettings.getBoolean("settings_key_specific_server", false)) {
	    mHost = mSettings.getString("settings_key_xmpp_server", "ec2-54-234-138-249.compute-1.amazonaws.com").trim();
	    if ("".equals(mHost))
		mHost = mService;
	...
	mHost = "ec2-54-234-138-249.compute-1.amazonaws.com";
	initConnectionConfig();
	configure(ProviderManager.getInstance());

	mNotificationManager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
	System.out.println("CONFIGURE   :::: ::   "+mConnectionConfiguration);
	System.out.println("CONFIGURE   :::: ::   "+mLogin);
	System.out.println("CONFIGURE   :::: ::   "+mPassword);
