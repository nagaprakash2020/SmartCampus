...
public class ContactList extends Activity {
	...
	if (item.getItemId() == R.id.contact_list_menu_settings) {
		startActivity(new Intent(this, Settings.class));
		return true;
	} else if (item.getItemId() == R.id.contact_list_menu_add_contact) {
		startActivity(new Intent(ContactList.this, AddContact.class));
		return true;
	} else if (item.getItemId() == R.id.menu_change_status) {
		startActivity(new Intent(ContactList.this, ChangeStatus.class));
		return true;
	} else if (item.getItemId() == R.id.contact_list_menu_chatlist) {
	...
	if (mSelectedContact != null) {
	    if (item.getItemId() == R.id.contact_list_context_menu_chat_item) {
			...
			result = true;
		} else if (item.getItemId() == R.id.contact_list_context_menu_call_item) {
			try {
			...
			result = true;
		} else if (item.getItemId() == R.id.contact_list_context_menu_user_info) {
			item.getSubMenu().setHeaderTitle(mSelectedContact.getJID());
			result = true;
		} else if (item.getItemId() == R.id.contact_list_context_menu_userinfo_alias) {
			Dialog alias = new Alias(ContactList.this, mRoster, mSelectedContact).create();
			alias.show();
			result = true;
		} else if (item.getItemId() == R.id.contact_list_context_menu_userinfo_group) {
			in = new Intent(this, GroupList.class);
			in.putExtra("contact", mSelectedContact);
			startActivity(in);
			result = true;
		} else if (item.getItemId() == R.id.contact_list_context_menu_userinfo_subscription) {
			Dialog subscription = new ResendSubscription(ContactList.this,
			mXmppFacade, mSelectedContact).create();
			subscription.show();
			result = true;
		} else if (item.getItemId() == R.id.contact_list_context_menu_userinfo_block) {
			result = true;
		} else if (item.getItemId() == R.id.contact_list_context_menu_userinfo_delete) {
	...
	public void onEntriesAdded(final List<String> addresses) throws RemoteException {
		...
		System.out.println(contact.getStatus()+".............STATUS");
