...
public class CreateAccount extends Activity {
    ...
    public static final String SERVICES = "amazona-2r9gfi9";
	...
	{
		//"", 5222, 
		System.out.println(getXMPPServer()+"................."+getXMPPPort());
//	    connectionConfiguration = new ConnectionConfiguration(getXMPPServer(), getXMPPPort(), "amazona-2r9gfi9");
		connectionConfiguration = new ConnectionConfiguration(getXMPPServer(), getXMPPPort(), SERVICES);
	} 
	/*else 
	{
...
//	    	xmppConnection.login(username, password);
	...
	String xmppServer = "ec2-54-234-138-249.compute-1.amazonaws.com";
	if (mSettings.getBoolean("settings_key_specific_server", false))
	    xmppServer = mSettings.getString("settings_key_xmpp_server", "ec2-54-234-138-249.compute-1.amazonaws.com");
	else
	    //xmppServer = StringUtils.parseServer("ec2-54-234-138-249.compute-1.amazonaws.com");
		mSettings.getString("settings_key_xmpp_server", "ec2-54-234-138-249.compute-1.amazonaws.com");
	return xmppServer;
    }
