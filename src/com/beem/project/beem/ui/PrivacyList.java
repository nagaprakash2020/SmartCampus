...
public class PrivacyList extends ListActivity {
	...
	if (item.getItemId() == R.id.privacy_list_context_menu_buddies_item) {
		return true;
	} else if (item.getItemId() == R.id.privacy_list_context_menu_groups_item) {
		return true;
	} else if (item.getItemId() == R.id.privacy_list_context_menu_delete_item) {
	...
	if (item.getItemId() == R.id.privacy_list_menu_create) {
